...
function buildSongRequestPrompt(songRequest) {
  const schema = {
    ...
    duration: '',
    source: '',
    sections: [{ name: 'Intro', bars: 4, chords: 'C | F | Am | G', color: 'intro', lead: 'quién manda o referencia principal', notes: 'nota de ensayo', layers: { voz: 'baja', armonia: 'media', bajo: 'media', bateria: 'media', full: 'media' } }],
    rehearsalNotes: [],
    decisions: [],
  };
  return [
    ...
    '',
    'Devuelve SOLO JSON válido, sin markdown, sin explicación y sin letra completa.',
